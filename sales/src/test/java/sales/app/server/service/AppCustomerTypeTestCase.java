...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("zKjCy1jHN9It3YTYF882xGyeflcEQc2wqSoPFqazm4SDrlUxiD");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("7euqYgzu4vXjiGWzGZoYTamNa1e7nbadcKx0KyikojkZqqbjId");
            appcustomertype.setDefaults(1);
            appcustomertype.setSequenceId(2147483647);
