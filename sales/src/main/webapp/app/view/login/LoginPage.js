Ext.define('Sales.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Sales.view.login.LoginPageController',
	             // 'Sales.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Sales.view.main.MainPanel' ],
