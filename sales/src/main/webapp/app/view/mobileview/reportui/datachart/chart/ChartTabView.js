Ext.define('Sales.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Sales.view.mobileview.reportui.datachart.chart.RatingField','Sales.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
