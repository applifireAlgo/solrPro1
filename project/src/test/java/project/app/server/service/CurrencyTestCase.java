...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("uv8nsegDf20av1phW9y3Y4hIPi01B4j2");
            country.setCapitalLatitude(3);
            country.setCapitalLongitude(0);
            country.setCountryCode1("sdz");
            country.setCountryCode2("As7");
            country.setCountryFlag("FXzFuiAV6nXULOsqJm73rO6nrYmO3sTXGAZUXx3FkwQLnZfzIE");
            country.setCountryName("yMBCkx7je7MWXbql7PNj0guBWYWZ0qHCIeaqMMGO2HBYZkKlw8");
            country.setCurrencyCode("aGD");
            country.setCurrencyName("MGkaQ6L8DaWc4euGXvD88saMTUZ5J8Lpm1BwvnqRUmSuzZLIPO");
            country.setCurrencySymbol("wKwjJUyae1fclv96uKNNkVMD1jvQjZoR");
            country.setIsoNumeric(11);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("yTT3EHhXSEsKo8WgfrWRC7aflYalgwkrQVXchShCmGYtOAaDHT");
            currency.setUnicodeDecimal("yKhwxzUfiVBxQIu6fPBU3OWzYpu9xFMj6ULQSueQLktPKEpRxM");
            currency.setUnicodeHex("dlKp2peB6ZBtAs9ErHnpJHbdq92UtxBfywlcvVKjhEBfbH75XG");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("tp8v0eptaGfOqCzgg1Fv1OSwSzPHQp2QmP0ELmrAG5HkS63FaT");
            currency.setUnicodeDecimal("P6JHneXlDJkdSZTm7Eyw5ydNUR5nSRVsEeweH3Zj3OX7lgXfJ9");
            currency.setUnicodeHex("hSEvnf7Yo2PnuVz9LvjHs4hxOdmw8joRDkLzEb2AUefYEkH0IM");
