...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("U63DMRrTECVNf5NpGIAKCpveEAWp5U5WxZnt0EctHJD56N7Z3u");
            useraccessdomain.setDomainHelp("S3HfpKyI0KmBm2TJYMrXVR7BhJoBfHiIYvmFEHBvlcy3JfOfPT");
            useraccessdomain.setDomainIcon("UmLSU7VOrVJDsmeKicfSL7sFil81xePaioAdE0mL0rb3DBOTcI");
            useraccessdomain.setDomainName("D88H09AxzL0k6C4leaN1jqSuewLsOxVcSPwophGKlHjkc6NrZw");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("LqwmyKUZcUsGx4gtr9H7zTKLyoW3gSnQuGecSuvhseuvPuYMdX");
            useraccesslevel.setLevelHelp("tVi6X4bsBuYiCTxaIspQQSTf3UIBRcl80dd5Wq0txzga3sE1ct");
            useraccesslevel.setLevelIcon("gyuUt9LuLr7udnHeaibFBYyEpeO48skLo3FzkTjw8Jou4X4lyN");
            useraccesslevel.setLevelName("lBm3ZYvnn6tJfzzHhgcEo7EgxPYDrPlZzZc5NolEIWE7AoLY6b");
            ...
            user.setPasswordAlgo("xOPia3KtEKBj20eKmHLgPdj6WZuPp28L1p0v4ns6Klvuu2p4Nl");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(205);
            user.setUserAccessCode(2);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("mYGY58G5C2ninMvfBt29hAcuLDfVfy50BUD9CXFC8X97Ry5Dei");
            Question question = new Question();
            question.setLevelid(2);
            question.setQuestion("wRTOs6Foo4ac6lEbwHDxr5zQ78ezn3TbBwxxVGS5ADSqkEpY4Z");
            question.setQuestionDetails("DUU");
            question.setQuestionIcon("Kt8XbwMKoKXVH3YJFHNcRTWJ5EDBKwGLZuPYezNU9oCnEpXBym");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("hm0gQSH2nvBNxkH8in8ILbb8rn15ysD77LEM4ifXtsVNU7nnkF");
