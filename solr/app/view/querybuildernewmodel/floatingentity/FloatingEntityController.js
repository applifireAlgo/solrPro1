Ext.define('Sales1.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Sales1.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Sales1.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Sales1.view.querybuildernewmodel.floatingentity.EntitySprite',
