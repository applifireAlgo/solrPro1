Ext.define('Sales1.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Sales1.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Sales1.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Sales1.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Sales1.view.querybuildernewmodel.querydetail.QueryDetail');
