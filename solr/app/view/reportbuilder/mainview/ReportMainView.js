Ext.define('Sales1.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Sales1.view.reportbuilder.reportlist.ReportListPanelView',
             'Sales1.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Sales1.view.reportbuilder.mainview.ReportMainController'
             ],
