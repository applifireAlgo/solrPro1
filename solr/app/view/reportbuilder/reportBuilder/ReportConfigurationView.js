Ext.define('Sales1.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Sales1.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Sales1.view.reportbuilder.gridconfig.GridConfigView',
	           'Sales1.view.reportbuilder.properties.PropertiesPanelView',
	           'Sales1.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
