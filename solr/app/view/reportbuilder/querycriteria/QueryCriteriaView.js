Ext.define('Sales1.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Sales1.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Sales1.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Sales1.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Sales1.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
