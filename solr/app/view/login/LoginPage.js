Ext.define('Sales1.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Sales1.view.login.LoginPageController',
	             // 'Sales1.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Sales1.view.main.MainPanel' ],
